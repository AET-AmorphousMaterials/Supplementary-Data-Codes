...
% save results
eval(['save ./Output/Pd2_nanoparticle/Polytetrahedral_motifs_delta_' num2str(delta) '.mat'])
end
...
for delta=[0.05 0.075 0.1 0.125 0.15 0.175 0.2 0.225 0.255 0.275 0.3 0.325 0.35]
ni=ni+1;
eval(['load ./Output/Pd2_nanoparticle/Polytetrahedral_motifs_delta_' num2str(delta) '.mat']) % laod above analysis results
