%% Main_1_pdf_and_boo_entire_sample
...
model=importdata([path, 'Final_atomic_model_Pd2_nanoparticle.mat']);
...
save('./Output/Pd2_nanoparticle/rdf_entire_sample.mat','r','g_r')

%% perform boo calculation
% read in files: finalized atomic coordinates in Angstrom
model=importdata([path, 'Final_atomic_model_Pd2_nanoparticle.mat']);
res=0.454;
cutoff=3.91; % first valley position in pdf
...
save('./Output/Pd2_nanoparticle/BOO_normalized.mat','model','order')
