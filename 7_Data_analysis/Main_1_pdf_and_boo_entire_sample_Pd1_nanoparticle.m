...
model=importdata([path, 'Final_atomic_model_Pd1_nanoparticle.mat']);
...
save('./Output/Pd1_nanoparticle/rdf_entire_sample.mat','r','g_r')

%% perform boo calculation
% read in files: finalized atomic coordinates in Angstrom
model=importdata([path, 'Final_atomic_model_Pd1_nanoparticle.mat']);
res=0.454;
cutoff=3.9; % first valley position in pdf
...
save('./Output/Pd1_nanoparticle/BOO_normalized.mat','model','order')
