...
load ./Input/Ta_film/Polytetrahedral_motifs_delta_0.255.mat
...
save(['./Output/Ta_film/Network_of_' num2str(iii) '_fold_motifs.mat'])
end
...
yyA=[];
for i=4:6
    data=importdata(['./Output/Ta_film/Network_of_' num2str(i) '_fold_motifs.mat']);
