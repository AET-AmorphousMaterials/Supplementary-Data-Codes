%% Main_2_pdf_and_voronoi_amorphous_region
...
% BOO
data=importdata('./Input/Pd2_nanoparticle/BOO_normalized.mat');
model=data.model;
order=data.order;
...
save('./Output/Pd2_nanoparticle/rdf_amorphous_region.mat','r','g_r')
...
bondlengthcutoff=3.91; % Voronoi neighbor should be within the 1st nerest shell distance (1st valley in pdf)
...
ylabel('Fraction')
save('./Output/Pd2_nanoparticle/Voronoi_amorphous_region.mat','Nindlist','indlist')