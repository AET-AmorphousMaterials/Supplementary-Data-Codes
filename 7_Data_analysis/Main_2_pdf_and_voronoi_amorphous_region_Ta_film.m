...
save('./Output/Ta_film/rdf_amorphous_region.mat','r','g_r')
...
bondlengthcutoff=4.12; % Voronoi neighbor should be within the 1st nerest shell distance (1st valley in pdf)
...
ylabel('Fraction')
save('./Output/Ta_film/Voronoi_amorphous_region.mat','Nindlist','indlist')
