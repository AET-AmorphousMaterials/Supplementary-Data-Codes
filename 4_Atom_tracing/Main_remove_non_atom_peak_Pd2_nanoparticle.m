...
addpath('./src/');
inputpath='./Input/';
saveprefix='Atom_tracing_non_atom_removed_Pd2_nanoparticle';

% load recontrcution volume
rec = importdata('../3_Final_reconstruction_volume/Pd2_particle_volume.mat');
rec=double(rec);

% load tracing results
TracingResult = importdata([inputpath 'Atom_tracing_all_peaks_Pd2_particle.mat']);
