...
clc
addpath('./src/')
inputDir = './Input/Pd1_nanoparticle/';
...
model=importdata([inputDir 'atomic_model_Pd1_particle.mat']);
...
save('./Output/Final_atomic_model_Pd1_nanoparticle.mat','model_refined')
